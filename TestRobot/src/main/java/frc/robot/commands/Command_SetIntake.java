 ...
 */
public class Command_SetIntake extends Command {
  private double speed;
  int axis;
  Button button;
  boolean bAxisButton; 
  public Command_SetIntake() {
    // Use requires() here to declare subsystem dependencies
    requires(Robot.intake);
  }
  public Command_SetIntake(double speed,Button button) {
    // Use requires() here to declare subsystem dependencies
   this();
   this.speed = speed;
   this.button = button;
  ...
  public Command_SetIntake(double speed, AxisButton button, int axis) {
    // Use requires() here to declare subsystem dependencies
   this();
   this.speed = speed;
   this.button = button;
