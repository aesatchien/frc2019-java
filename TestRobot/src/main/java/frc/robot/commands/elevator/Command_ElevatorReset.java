...
public class Command_ElevatorReset extends Command {
  Button button;

// Don't want to call this w/o giving a button to release
  private Command_ElevatorReset() {
    requires(Robot.elevator);
  }
  public Command_ElevatorReset(Button button) {
    this();
    this.button = button;
  }
  ...
  protected void initialize() {
    ...
    Robot.elevator.setElevatorPower(0.01);
  }
